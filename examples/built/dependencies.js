...
********************************************** */ (function() {
    ...
    var logged = false;
    /** @deprecated Use `Prism.plugins.fileHighlight.highlight` instead. */ Prism$1.fileHighlight = function() {
        if (!logged) {
...
(_Symbol = Symbol).metadata ?? (_Symbol.metadata = Symbol("metadata")), (_a = a$1).litPropertyMetadata ?? (_a.litPropertyMetadata = new WeakMap);
 ...
 */ class ExampleSnippet extends b {
    stamp() {
        ...
        const stampTarget = this.stampTo == null ? this : root.getElementById(this.stampTo);
        if (stampTarget != null) {
            let parentNode;
