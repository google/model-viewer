...
import {Constructor, Model, ThreeDOMElement as ThreeDOMElementInterface} from '../api.js';

import {ModelKernel} from './model-kernel.js';

export function defineThreeDOMElement(): Constructor<ThreeDOMElementInterface> {
