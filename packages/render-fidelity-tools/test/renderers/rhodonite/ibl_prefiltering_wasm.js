...
function __wbg_adapter_26(arg0, arg1, arg2) {
  wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___suite__invoke__hd685b44b493b72c9(
...
function getFloat32Memory0() {
  if (cachegetFloat32Memory0 === null ||
...
function __wbg_adapter_191(arg0, arg1, arg2, arg3) {
  wasm.wasm_bindgen__convert__closures__invoke2_mut__h99a8a5b17106f958(
...
class CubeMapPrefilter {
   ...
   */
  constructor(
      webgl_context, cubemap_size, irradiance_cubemap_size, pmrem_cubemap_size,
      pmrem_cubemap_mip_count, brdf_lut_size, sample_count) {
    var ret = wasm.cubemapprefilter_new(
        addHeapObject(webgl_context),
        cubemap_size,
  ...
  load_hdr_image(webgl_context, data) {
    wasm.cubemapprefilter_load_hdr_image(
        this.ptr, addHeapObject(webgl_context), addHeapObject(data));
  }
  /**
   * @returns {any}
   */
  ...
  process(webgl_context) {
    var ret =
        wasm.cubemapprefilter_process(this.ptr, addHeapObject(webgl_context));
    return takeObject(ret);
  }
  /**
   * @param {any} webgl_context
  ...
  draw_env(webgl_context, view_data, proj_data) {
    var ret = wasm.cubemapprefilter_draw_env(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(view_data),
        addHeapObject(proj_data));
    return takeObject(ret);
  }
  /**
   * @param {any} webgl_context
   ...
   */
  draw_pbr(
      webgl_context, metallic_data, roughness_data, albedo_data,
      local_to_world_matrix, camera_position_data, view_data, proj_data) {
    var ret = wasm.cubemapprefilter_draw_pbr(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(metallic_data),
        addHeapObject(roughness_data),
        addHeapObject(albedo_data),
        addHeapObject(local_to_world_matrix),
        addHeapObject(camera_position_data),
        addHeapObject(view_data),
        addHeapObject(proj_data));
    return takeObject(ret);
  }
  ...
  hdr_cubemap_texture_to_arrybuffer(webgl_context, cube_face_target) {
    var ret = wasm.cubemapprefilter_hdr_cubemap_texture_to_arrybuffer(
        this.ptr, addHeapObject(webgl_context), cube_face_target);
    return takeObject(ret);
  }
  /**
   * @param {any} webgl_context
  ...
  irradiance_cubemap_texture_to_arrybuffer(webgl_context, cube_face_target) {
    var ret = wasm.cubemapprefilter_irradiance_cubemap_texture_to_arrybuffer(
        this.ptr, addHeapObject(webgl_context), cube_face_target);
    return takeObject(ret);
  }
  /**
   ...
   * @returns {any}
   */
  pmrem_cubemap_texture_to_arrybuffer(
      webgl_context, cube_face_target, mip_level) {
    var ret = wasm.cubemapprefilter_pmrem_cubemap_texture_to_arrybuffer(
        this.ptr, addHeapObject(webgl_context), cube_face_target, mip_level);
    return takeObject(ret);
  }
  /**
   * @returns {number}
  ...
  pmrem_cubemap_texture_size(mip_level) {
    var ret =
        wasm.cubemapprefilter_pmrem_cubemap_texture_size(this.ptr, mip_level);
    return ret >>> 0;
  }
  /**
   * @returns {number}
  ...
  brdf_texture_to_arrybuffer(webgl_context) {
    var ret = wasm.cubemapprefilter_brdf_texture_to_arrybuffer(
        this.ptr, addHeapObject(webgl_context));
    return takeObject(ret);
  }
  /**
   * @returns {number}
  ...
  capture_texture(webgl_context) {
    wasm.cubemapprefilter_capture_texture(
        this.ptr, addHeapObject(webgl_context));
  }
  /**
   * @returns {any}
...
class DebugRenderer {
   ...
   */
  load_hdr_image(webgl_context, data) {
    wasm.debugrenderer_load_hdr_image(
        this.ptr, addHeapObject(webgl_context), addHeapObject(data));
  }
  /**
   * @param {any} webgl_context
  ...
  draw_unwrapped_cube_with_debug_shader(webgl_context, x, y, w, h, _lod_bias) {
    var ret = wasm.debugrenderer_draw_unwrapped_cube_with_debug_shader(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(x),
        addHeapObject(y),
  ...
  draw_unwrapped_cube(webgl_context, gl_texture, x, y, w, h, lod_bias) {
    var ret = wasm.debugrenderer_draw_unwrapped_cube(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(gl_texture),
        addHeapObject(x),
        addHeapObject(y),
        addHeapObject(w),
        addHeapObject(h),
        addHeapObject(lod_bias));
    return takeObject(ret);
  }
  /**
   * @param {any} webgl_context
   ...
   * @returns {any}
   */
  draw_unwrapped_cube_with_debug_cube_texture(
      webgl_context, x, y, w, h, lod_bias) {
    var ret = wasm.debugrenderer_draw_unwrapped_cube_with_debug_cube_texture(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(x),
        addHeapObject(y),
...
class PreviewRGBEImage {
  ...
  load_rgbe_image(webgl_context, data, width, height) {
    wasm.previewrgbeimage_load_rgbe_image(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(data),
        addHeapObject(width),
        addHeapObject(height));
  }
  /**
   * @param {any} webgl_context
   * @param {any} x
  ...
  draw(webgl_context, x, y, w, h) {
    var ret = wasm.previewrgbeimage_draw(
        this.ptr,
        addHeapObject(webgl_context),
        addHeapObject(x),
        addHeapObject(y),
...
async function init(input) {
  ...
  imports.wbg.__wbg_text_7c3304aebfcffa1a = function() {
    return handleError(function(arg0) {
  ...
  imports.wbg.__wbg_bufferData_fc1c7f6f7937aa2f = function(
      arg0, arg1, arg2, arg3) {
    getObject(arg0).bufferData(arg1 >>> 0, getObject(arg2), arg3 >>> 0);
  };
  imports.wbg.__wbg_readPixels_b660acaeb93b7ae6 = function() {
    return handleError(
        function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
          getObject(arg0).readPixels(
              arg1, arg2, arg3, arg4, arg5 >>> 0, arg6 >>> 0, getObject(arg7));
        },
        arguments)
  };
  imports.wbg.__wbg_texImage2D_c3b3326e5afec2cb = function() {
    return handleError(
  ...
  imports.wbg.__wbg_texImage2D_875a12810798bd91 = function() {
    return handleError(
        function(
  ...
  imports.wbg.__wbg_texSubImage2D_49734ace3c625b9a = function() {
    return handleError(
        function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
  ...
  imports.wbg.__wbg_uniformMatrix4fv_ec627ec788c1b744 = function(
      arg0, arg1, arg2, arg3, arg4) {
    getObject(arg0).uniformMatrix4fv(
        getObject(arg1), arg2 !== 0, getArrayF32FromWasm0(arg3, arg4));
  };
  ...
  imports.wbg.__wbg_bindFramebuffer_29a489c53aeadc0a = function(
      arg0, arg1, arg2) {
    getObject(arg0).bindFramebuffer(arg1 >>> 0, getObject(arg2));
  };
  imports.wbg.__wbg_bindRenderbuffer_1ddc77aab39d4644 = function(
      arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_checkFramebufferStatus_bf99999b983319bd = function(
      arg0, arg1) {
  ...
  imports.wbg.__wbg_clearColor_e0034d2b65202787 = function(
      arg0, arg1, arg2, arg3, arg4) {
  ...
  imports.wbg.__wbg_copyTexSubImage2D_4e74ac55bae3ed88 = function(
      arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
    getObject(arg0).copyTexSubImage2D(
        arg1 >>> 0, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
  };
  ...
  imports.wbg.__wbg_drawArrays_0b3f5c1007f09b54 = function(
      arg0, arg1, arg2, arg3) {
    getObject(arg0).drawArrays(arg1 >>> 0, arg2, arg3);
  };
  imports.wbg.__wbg_drawElements_4ec52596f5751396 = function(
      arg0, arg1, arg2, arg3, arg4) {
  ...
  imports.wbg.__wbg_enableVertexAttribArray_4b127e0ecccd536c = function(
      arg0, arg1) {
  ...
  imports.wbg.__wbg_framebufferRenderbuffer_634c46c93b74a802 = function(
      arg0, arg1, arg2, arg3, arg4) {
    getObject(arg0).framebufferRenderbuffer(
        arg1 >>> 0, arg2 >>> 0, arg3 >>> 0, getObject(arg4));
  };
  imports.wbg.__wbg_framebufferTexture2D_73cc0dcc63da2ffc = function(
      arg0, arg1, arg2, arg3, arg4, arg5) {
    getObject(arg0).framebufferTexture2D(
        arg1 >>> 0, arg2 >>> 0, arg3 >>> 0, getObject(arg4), arg5);
  };
  imports.wbg.__wbg_generateMipmap_df35e7716b224153 = function(arg0, arg1) {
    getObject(arg0).generateMipmap(arg1 >>> 0);
  };
  imports.wbg.__wbg_getAttribLocation_e3a341ce3579c6e6 = function(
      arg0, arg1, arg2, arg3) {
    var ret = getObject(arg0).getAttribLocation(
        getObject(arg1), getStringFromWasm0(arg2, arg3));
    return ret;
  };
  imports.wbg.__wbg_getExtension_adbea5bb34c458b0 = function() {
    return handleError(function(arg0, arg1, arg2) {
      var ret = getObject(arg0).getExtension(getStringFromWasm0(arg1, arg2));
      return isLikeNone(ret) ? 0 : addHeapObject(ret);
    }, arguments)
  };
  imports.wbg.__wbg_getParameter_0b14f998f44dc570 = function() {
    return handleError(function(arg0, arg1) {
      var ret = getObject(arg0).getParameter(arg1 >>> 0);
      return addHeapObject(ret);
    }, arguments)
  };
  imports.wbg.__wbg_getProgramInfoLog_0b10742df7a2ebea = function(
      arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_getShaderInfoLog_950ab0c3fc7afa37 = function(
      arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_getShaderParameter_54891c5545a79869 = function(
      arg0, arg1, arg2) {
    var ret = getObject(arg0).getShaderParameter(getObject(arg1), arg2 >>> 0);
    return addHeapObject(ret);
  };
  imports.wbg.__wbg_getUniformLocation_8b0d07c81923dc0a = function(
      arg0, arg1, arg2, arg3) {
    var ret = getObject(arg0).getUniformLocation(
        getObject(arg1), getStringFromWasm0(arg2, arg3));
    return isLikeNone(ret) ? 0 : addHeapObject(ret);
  };
  ...
  imports.wbg.__wbg_renderbufferStorage_51304869bb2aad8c = function(
      arg0, arg1, arg2, arg3, arg4) {
    getObject(arg0).renderbufferStorage(arg1 >>> 0, arg2 >>> 0, arg3, arg4);
  };
  imports.wbg.__wbg_shaderSource_c666880b620c8f34 = function(
      arg0, arg1, arg2, arg3) {
    getObject(arg0).shaderSource(
        getObject(arg1), getStringFromWasm0(arg2, arg3));
  };
  imports.wbg.__wbg_texParameteri_dd58ff2ef56511b2 = function(
      arg0, arg1, arg2, arg3) {
  ...
  imports.wbg.__wbg_uniform3f_35b8f0f096e8197a = function(
      arg0, arg1, arg2, arg3, arg4) {
  ...
  imports.wbg.__wbg_vertexAttribPointer_d00262e9bf7a3742 = function(
      arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    getObject(arg0).vertexAttribPointer(
        arg1 >>> 0, arg2, arg3 >>> 0, arg4 !== 0, arg5, arg6);
  };
  imports.wbg.__wbg_viewport_39356c8cdec98b8b = function(
      arg0, arg1, arg2, arg3, arg4) {
  ...
  imports.wbg.__wbg_newwithbyteoffsetandlength_9f0558f3c1740b0a = function(
      arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_newwithbyteoffsetandlength_abfc24c57fd08e6d = function(
      arg0, arg1, arg2) {
