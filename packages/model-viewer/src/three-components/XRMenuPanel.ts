...
import {CanvasTexture, LinearFilter, Mesh, MeshBasicMaterial, Object3D, PlaneGeometry, Shape, ShapeGeometry, XRTargetRaySpace} from 'three';
...
export class XRMenuPanel extends Object3D {
  ...
  constructor() {
    ...
    //  straight horizontal bottom edge and a rounded bottom-right corner with a
    //  radius of r
    ...
    const material = new MeshBasicMaterial(
        {color: 0x000000, opacity: MAX_OPACITY, transparent: true});
