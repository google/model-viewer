...
import {EulerDegrees, GltfModel, TextureHandle} from '@google/model-viewer-editing-adapter/lib/main.js'
...
export async function applyEdits(
  ...
  if (edits.objectRotation !== oldEdits.objectRotation) {
    model.objectRotationEulers = edits.objectRotation;
  }
...
export async function getGltfEdits(model: GltfModel): Promise<GltfEdits> {
  ...
  return {
    ...
    objectRotation: model.objectRotationEulers,
  };
}
