...
// import {getGltfModel} from
// '../../components/model_viewer_preview/reducer.js'; import {dispatchGltfUrl}
// from '../../components/model_viewer_preview/reducer.js'; import {reduxStore}
// from '../../space_opera_base.js'; import {until} from
// '../utils/test_utils.js';
...
describe('ModelViewerPreview', () => {
  ...
  // TODO: This test is flaky, so it's being commented out for now...
  // it('updates ', async () => {
  //   const gltfJson = {
