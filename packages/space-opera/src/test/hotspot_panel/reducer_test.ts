...
// import {dispatchAddHotspot, dispatchClearHotspot, dispatchRemoveHotspot,
// dispatchSetHotspots, dispatchUpdateHotspot, generateUniqueHotspotName} from
// '../../components/hotspot_panel/reducer.js'; import {reduxStore} from
// '../../space_opera_base.js';
import {dispatchClearHotspot} from '../../components/hotspot_panel/reducer.js';
...
describe('hotspot dispatchers test', () => {
  ...
  //   it('updates a hotspot when dispatchUpdateHotspot is called with valid
  //   config',
  //      () => {
  //        const config = {
  //          name: 'test',
  ...
  //   it('throws an error when dispatchUpdateHotspot is called with configs
  //   with \ non-existing hotspot names',
  //      () => {
  //        const config = {
  //          name: 'test',
  //          position: toVector3D([1, 0, 0]),
  ...
  //   it('removes a hotspot when dispatchRemoveHotspot is called with valid
  //   config',
  //      () => {
  //        dispatchAddHotspot({
  //          name: 'test',
  ...
  //   it('throws an error when dispatchRemoveHotspot is called with configs
  //   with \ non-existing hotspot names',
  //      () => {
  //        const config = {
  //          name: 'test',
  ...
  //   it('generates unique hotspot name when genearteUniqueHotspotName is
  //   called',
  //      () => {
  //        dispatchAddHotspot({
  ...
  //   it('generates unique hotspot name when generateUniqueHotspotName is
  //   called \ after loading previously set hotspots',
  //      () => {
  //        dispatchSetHotspots([
  //          {name: generateUniqueHotspotName(), position: toVector3D([1, 0,
  //          0])}, {name: generateUniqueHotspotName(), position: toVector3D([2,
  //          0, 0])},
  //        ]);
  //        let hotspots = reduxStore.getState().hotspots;
  //        dispatchClearHotspot();
