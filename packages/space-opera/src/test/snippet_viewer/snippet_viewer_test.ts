...
describe('snippet viewer test', () => {
  ...
  it('formatted HTML strips Lit comments', async () => {
    ...
    snippetViewer.renderedSnippet = html`<!--?lit$343342268$--><model-viewer enable-pan="" src="Astronaut.glb" ar="" ar-modes="webxr scene-viewer quick-look" camera-controls="" environment-image="neutral" poster="poster.webp" shadow-intensity="1" ar-status="not-presenting">
    <!--?lit$128424273$--><!---->
...
<img>
    ...
    const goldenFormattedHTML =
        `<model-viewer enable-pan src="Astronaut.glb" ar ar-modes="webxr scene-viewer quick-look" camera-controls environment-image="neutral" poster="poster.webp" shadow-intensity="1">
    <div class="progress-bar hide" slot="progress-bar">
        <div class="update-bar"></div>
    </div>
    <button slot="ar-button" id="ar-button">
  ...
  it('formatted HTML does not greedily strip comments', async () => {
    ...
    snippetViewer.renderedSnippet = html`<!--?lit$128424273$--><model-viewer enable-pan="" src="Astronaut.glb" ar="" ar-modes="webxr scene-viewer quick-look" camera-controls="" environment-image="neutral" poster="poster.webp" shadow-intensity="1" ar-status="not-presenting">
