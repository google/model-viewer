...
export class MaterialPanel extends ConnectedLitElement {
  ...
  <me-expandable-tab tabName="Metallic Roughness">
    <div slot="content" class="${
        this.texturesById && this.texturesById.size > 0 ?
            'TexturePickerContent' :
            'MRContentNoTextures'}">
      ...
      <div class="MRSliders">
        ...
        <me-slider-with-input id="metallic-factor" class="filter-slider" min="0.0" max="1.0"
        ...
        <me-slider-with-input id="roughness-factor" class="filter-slider" min="0.0" max="1.0"
  ...
  <me-expandable-tab tabName="Base Color">
    <div slot="content" class="TexturePickerContent">
        <me-color-picker class="BaseColorSwatch" id="base-color-picker"
  ...
  <me-expandable-tab tabName="Emissive Map Texture">
    <div slot="content" class="TexturePickerContent">
      <me-color-picker class="BaseColorSwatch" selectedColorHex=${
