...
/**
 * Component for viewing/editing the m-v snippet.
 */
@customElement('model-viewer-snippet')
export class ModelViewerSnippet extends ConnectedLitElement {
  static get styles() {
    return css`
  #mv-input {
    width: 95%;
  ...
  render() {
    ...
    <div slot="content">
      <me-download-button id="download-gltf"></me-download-button><br/>
      <br/>
