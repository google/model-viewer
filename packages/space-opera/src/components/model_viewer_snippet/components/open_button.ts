...
import {modelViewerSnippetUploadStyles} from '../../../styles.css.js';
...
export class OpenModal extends LitElement {
  static styles = modelViewerSnippetUploadStyles;
...
export class OpenButton extends LitElement {
  ...
  render() {
    return html`
        ...
        <mwc-button unelevated icon="upload_file" @click=${this.onClick}>
          Upload
        </mwc-button>`;
  }
}
