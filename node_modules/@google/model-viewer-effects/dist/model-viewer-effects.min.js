 ...
 */
function zi(e,t,i){return Math.max(t,Math.min(i,e))}function ki(e,t,i){return e>i?t:e<t?i:e}function Qi(e){return!!(e.getAttributes()&ze)}function Yi(e,t){if(!e.includes(t))throw new TypeError(`Validation Error: ${t} is not a valid value. Expected ${e.join(" | ")}`)}
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Gi?.({LitElement:Ni}),(globalThis.litElementVersions??=[]).push("4.1.1");var Vi,Xi,Wi,Ki=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};const ji=Symbol("scene"),Zi=Symbol("composer"),Ji=Symbol("modelViewerElement"),qi=Symbol("effectComposer"),_i=Symbol("renderPass"),$i=Symbol("normalPass"),es=Symbol("effectsPass"),ts=Symbol("requires"),is=Symbol("effects"),ss=Symbol("selection"),rs=Symbol("onSceneLoad"),ns=Symbol("resetEffectPasses"),as=Symbol("userEffectCount"),os=Symbol("tonemapping"),ls=Symbol("updateProperties");class cs extends He{constructor(e,t){super(e,t),this[Vi]=n}preRender(){const e=this.getRenderer();e.autoClear=!1,e.toneMapping=this[os]}postRender(){const e=this.getRenderer();e.toneMapping=n,e.autoClear=!0}render(e){this.preRender(),super.render(e),this.postRender()}addPass(e,t){super.addPass(e,t),this.refresh()}setMainCamera(e){this.camera=e,super.setMainCamera(e)}setMainScene(e){this.scene=e,super.setMainScene(e)}refresh(){this.camera&&this.scene&&(super.setMainCamera(this.camera),super.setMainScene(this.scene))}beforeRender(e,t){var i;this.dirtyRender&&(null===(i=this.scene)||void 0===i||i.queueRender())}}Vi=os;const hs=["performance","quality"];class us extends Ce{static get is(){return"effect-composer"}get[(Xi=as,qi)](){if(!this[Zi])throw new Error("The EffectComposer has not been instantiated yet. Please make sure the component is properly mounted on the Document within a <model-viewer> element.");return this[Zi]}get userPasses(){return this[qi].passes.slice(2,2+this[as])}get modelViewerElement(){if(!this[Ji])throw new Error("<effect-composer> must be a child of a <model-viewer> component.");return this[Ji]}get normalBuffer(){return this[$i].texture}get selection(){return this[ss]}constructor(){super(),this.renderMode="performance",this.msaa=0,this[Xi]=0,this[Wi]=()=>{var e;this[qi].refresh(),this[ss].clear(),null===(e=this[ji])||void 0===e||e.traverse((e=>e.hasOwnProperty("geometry")&&this[ss].add(e))),this.dispatchEvent(new CustomEvent("updated-selection"))},this[_i]=new Mt,this[$i]=new ii,this[ss]=new je}connectedCallback(){var e;super.connectedCallback&&super.connectedCallback(),"model-viewer"===(null===(e=this.parentNode)||void 0===e?void 0:e.nodeName.toLowerCase())&&(this[Ji]=this.parentNode);try{Yi(hs,this.renderMode)}catch(e){console.error(e.message+"\nrenderMode defaulting to: performance")}this[Zi]=new cs(void 0,{stencilBuffer:!0,multisampling:this.msaa,frameBufferType:"quality"===this.renderMode?s:r}),this.modelViewerElement.registerEffectComposer(this[qi]),this[qi].addPass(this[_i],0),this[qi].addPass(this[$i],1),this[rs](),this.modelViewerElement.addEventListener("before-render",this[rs]),this.updateEffects()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.modelViewerElement.unregisterEffectComposer(),this.modelViewerElement.removeEventListener("before-render",this[rs]),this[qi].dispose()}updated(e){if(super.updated(e),e.has("msaa")&&(this[qi].multisampling=this.msaa),e.has("renderMode")&&void 0!==e.get("renderMode"))throw new Error("renderMode cannot be changed after startup.")}addPass(e,t,i){e.requireNormals=t,e.requireDirtyRender=i,this[qi].addPass(e,this[as]+2),this[as]++,this[ls]()}removePass(e,t=!0){if(!this[qi].passes.includes(e))throw new Error(`Pass ${e.name} not found.`);this[qi].removePass(e),t&&e.dispose(),this[ls](),this[as]--}updateEffects(){this[ns]();const e=this[is];let t=0;for(;t<e.length;){const i=e.slice(t).findIndex((e=>e.requireSeparatePass||Qi(e)));if(0!=i){const s=new ti(void 0,...e.slice(t,-1==i?e.length:i));this[qi].addPass(s)}if(-1==i)break;{const s=new ti(void 0,e[t+i]);this[qi].addPass(s),t+=i+1}}this[ls](),this.queueRender()}queueRender(){var e;null===(e=this[ji])||void 0===e||e.queueRender()}get[ji](){return this[qi].scene}get[is](){const e=[];for(let t=0;t<this.children.length;t++){const i=this.children.item(t);if(!i.effects)continue;const s=i.effects;s&&e.push(...s.filter((e=>!e.disabled)))}return e}get[es](){return this[qi].passes.slice(2+this[as])}[(Wi=rs,ls)](){this[$i].enabled=this[ts]("requireNormals"),this[$i].renderToScreen=!1,this[qi].dirtyRender=this[ts]("requireDirtyRender"),this[_i].renderToScreen=2===this[qi].passes.length}[ts](e){return this[qi].passes.some((t=>t[e]||t.effects&&t.effects.some((t=>t[e]))))}[ns](){this[es].forEach((e=>{this[qi].removePass(e),function(e){if(Pe.prototype.dispose.call(e),e.listener)for(const t of e.effects)t.removeEventListener("change",e.listener)}(e)}))}}Ki([Se({type:String,attribute:"render-mode"})],us.prototype,"renderMode",void 0),Ki([Se({type:Number,attribute:"msaa"})],us.prototype,"msaa",void 0);
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
var ds=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};const fs=Symbol("setDefaultProperties"),gs=Object.keys(Ze);
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
function ps(e){return Math.round(zi(e+1,_e,tt+1))-1}const vs=new t,As=Symbol("updateProperties"),ms=Symbol("effectOptions"),xs=(e=>{class t extends e{constructor(){super(...arguments),this.blendMode="DEFAULT",this.opacity=1}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[fs]()}updated(e){super.updated(e),(e.has("blendMode")||e.has("opacity"))&&(this.opacity=zi(this.opacity,0,1),this.blendMode=this.blendMode.toUpperCase(),this.effects.forEach((e=>{if("DEFAULT"===this.blendMode){if(void 0===e.blendMode.defaultBlendFunction)throw new Error(`${e.name} has no default blend function`);e.blendMode.blendFunction=e.blendMode.defaultBlendFunction}else Yi(gs,this.blendMode),e.blendMode.blendFunction=Ze[this.blendMode];e.disabled="SKIP"===this.blendMode,e.blendMode.setOpacity(this.opacity)})),"SKIP"!==this.blendMode&&"SKIP"!==e.get("blendMode")||this.effectComposer.updateEffects(),this.effectComposer.queueRender())}[fs](){this.effects.forEach((e=>{e.blendMode.defaultBlendFunction=e.blendMode.blendFunction}))}}return ds([Se({type:String,attribute:"blend-mode",reflect:!0})],t.prototype,"blendMode",void 0),ds([Se({type:Number,attribute:"opacity",reflect:!0})],t.prototype,"opacity",void 0),t})((Es=Ni,class extends Es{get effectComposer(){if(!this[qi])throw new Error("<"+this.constructor.name.replace("MV","").split(/(?=[A-Z])/).join("-").toLowerCase()+"> must be a child of a <model-viewer> component.");return this[qi]}connectedCallback(){var e;super.connectedCallback&&super.connectedCallback(),"effect-composer"===(null===(e=this.parentNode)||void 0===e?void 0:e.nodeName.toLowerCase())&&(this[qi]=this.parentNode),this.effectComposer.updateEffects()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.effects.forEach((e=>e.dispose())),this.effectComposer.updateEffects()}}));
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Es,Ds=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};class Cs extends xs{static get is(){return"bloom-effect"}constructor(){super(),this.strength=1,this.threshold=.85,this.radius=.85,this.smoothing=.025,this.effects=[new ut(this[ms])]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),(e.has("strength")||e.has("threshold")||e.has("smoothing")||e.has("radius"))&&this[As]()}[As](){this.effects[0].luminanceMaterial.threshold=this.threshold,this.effects[0].luminanceMaterial.smoothing=this.smoothing,this.effects[0].intensity=this.strength,this.effects[0].mipmapBlurPass.radius=this.radius,this.effectComposer.queueRender()}get[ms](){return{blendFunction:Ze.ADD,mipmapBlur:!0,radius:this.radius,luminanceThreshold:this.threshold,luminanceSmoothing:this.smoothing,intensity:this.strength}}}Ds([Se({type:Number,attribute:"strength",reflect:!0})],Cs.prototype,"strength",void 0),Ds([Se({type:Number,attribute:"threshold",reflect:!0})],Cs.prototype,"threshold",void 0),Ds([Se({type:Number,attribute:"radius",reflect:!0})],Cs.prototype,"radius",void 0),Ds([Se({type:Number,attribute:"smoothing",reflect:!0})],Cs.prototype,"smoothing",void 0);
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
var ws=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};const Bs=2*Math.PI,Ss=Object.keys(Ot);class ys extends xs{static get is(){return"color-grade-effect"}constructor(){super(),this.tonemapping="ACES_FILMIC",this.brightness=0,this.contrast=0,this.saturation=0,this.hue=0,this.effects=[new qt({mode:Ot.ACES_FILMIC}),new Pt({hue:ki(this.hue,0,Bs),saturation:zi(this.saturation,-1,1),blendFunction:Ze.SRC}),new dt({brightness:zi(this.brightness,-1,1),contrast:zi(this.contrast,-1,1),blendFunction:Ze.SRC})]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),(e.has("tonemapping")||e.has("brightness")||e.has("contrast")||e.has("hue")||e.has("saturation")||e.has("blendMode"))&&this[As]()}[As](){"SKIP"===this.blendMode?this.effectComposer[qi][os]=n:this.effectComposer[qi][os]=a,this.saturation=zi(this.saturation,-1,1),this.hue=ki(this.hue,0,Bs),this.brightness=zi(this.brightness,-1,1),this.contrast=zi(this.contrast,-1,1),this.effects[1].saturation=this.saturation,this.effects[1].hue=this.hue,this.effects[2].brightness=this.brightness,this.effects[2].contrast=this.contrast;try{this.tonemapping=this.tonemapping.toUpperCase(),Yi(Ss,this.tonemapping),this.effects[0].mode=Ot[this.tonemapping]}finally{this.effectComposer.queueRender()}}}ws([Se({type:String,attribute:"tonemapping",reflect:!0})],ys.prototype,"tonemapping",void 0),ws([Se({type:Number,attribute:"brightness",reflect:!0})],ys.prototype,"brightness",void 0),ws([Se({type:Number,attribute:"contrast",reflect:!0})],ys.prototype,"contrast",void 0),ws([Se({type:Number,attribute:"saturation",reflect:!0})],ys.prototype,"saturation",void 0),ws([Se({type:Number,attribute:"hue",reflect:!0})],ys.prototype,"hue",void 0);
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
var Ts=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};const Ms=["sporadic","constant"];class Ps extends xs{static get is(){return"glitch-effect"}constructor(){super(),this.strength=.5,this.mode="sporadic";const e=new ft,t=new Bt(this[ms](e));this.effects=[t,e],this.effects[1].requireDirtyRender=!0}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),(e.has("mode")||e.has("strength"))&&this[As]()}[As](){this.strength=zi(this.strength,0,1),this.mode=this.mode.toLowerCase();try{Yi(Ms,this.mode)}catch(e){console.error(e.message+NaN)}0==this.strength?(this.effects[0].columns=0,this.effects[0].mode="constant"===this.mode?xt:mt):(this.effects[0].columns=.06,this.effects[0].mode="constant"===this.mode?Et:mt),this.effects[0].maxStrength=this.strength,this.effects[0].ratio=1-this.strength}[ms](e){return this.strength=zi(this.strength,0,1),{chromaticAberrationOffset:e.offset,delay:new o(1e3,3500),duration:new o(500,1e3),strength:new o(.075,this.strength),ratio:1-this.strength}}}Ts([Se({type:Number,attribute:"strength",reflect:!0})],Ps.prototype,"strength",void 0),Ts([Se({type:String,attribute:"mode",reflect:!0})],Ps.prototype,"mode",void 0);const Is=Symbol("setSelection"),bs=e=>{var t;class i extends e{constructor(){super(...arguments),this.selection=[],this[t]=()=>{var e;const{effectComposer:t}=this;if(t)if((null===(e=this.selection)||void 0===e?void 0:e.length)>0){const e=[],i=t[ji];null==i||i.traverse((t=>(this.selection.includes(t.name)||this.selection.includes(t))&&e.push(t))),this.effects.forEach((t=>{var i;return null===(i=t.selection)||void 0===i?void 0:i.set(e)}))}else this.effects.forEach((e=>{var i;return null===(i=e.selection)||void 0===i?void 0:i.set(t[ss].values())}))}}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[Is](),this.effectComposer.addEventListener("updated-selection",this[Is])}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.effectComposer.removeEventListener("updated-selection",this[Is])}updated(e){super.updated(e),e.has("selection")&&(this[Is](),this.effectComposer.queueRender())}}return t=Is,function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);n>3&&a&&Object.defineProperty(t,i,a)}([Se({type:Array})],i.prototype,"selection",void 0),i};
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
var Rs=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};class Os extends(bs(xs)){static get is(){return"outline-effect"}constructor(){super(),this.color="white",this.strength=1,this.smoothing=1,this.effects=[new Ht(void 0,vs,this[ms])]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),(e.has("color")||e.has("smoothing")||e.has("strength"))&&this[As]()}[As](){this.effects[0].edgeStrength=this.strength,this.effects[0].visibleEdgeColor=new i(this.color),this.effects[0].hiddenEdgeColor=new i(this.color),this.effects[0].blurPass.enabled=Math.round(this.smoothing)>0,this.effects[0].blurPass.kernelSize=ps(this.smoothing),this.effectComposer.queueRender()}get[ms](){return{blendFunction:Ze.SCREEN,edgeStrength:this.strength,pulseSpeed:0,visibleEdgeColor:new i(this.color).getHex(),hiddenEdgeColor:new i(this.color).getHex(),blur:Math.round(this.smoothing)>0,kernelSize:ps(this.smoothing),xRay:!0,resolutionScale:1}}}Rs([Se({type:String||Number,attribute:"color",reflect:!0})],Os.prototype,"color",void 0),Rs([Se({type:Number,attribute:"strength",reflect:!0})],Os.prototype,"strength",void 0),Rs([Se({type:Number,attribute:"smoothing",reflect:!0})],Os.prototype,"smoothing",void 0);class Us extends xs{static get is(){return"pixelate-effect"}constructor(){super(),this.granularity=10,this.effects=[new Nt(this.granularity)]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),e.has("granularity")&&this[As]()}[As](){this.effects[0].granularity=this.granularity,this.effectComposer.queueRender()}}!function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);n>3&&a&&Object.defineProperty(t,i,a)}([Se({type:Number,attribute:"granularity",reflect:!0})],Us.prototype,"granularity",void 0);const Ls=Object.keys(Rt);class Fs extends xs{static get is(){return"smaa-effect"}constructor(){super(),this.quality="MEDIUM",this.effects=[new Vt({preset:Rt[this.quality]})]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),e.has("quality")&&this[As]()}[As](){this.quality=this.quality.toUpperCase(),Yi(Ls,this.quality),this.effects[0].applyPreset(Rt[this.quality]),this.effectComposer.queueRender()}}!function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);n>3&&a&&Object.defineProperty(t,i,a)}([Se({type:String,attribute:"quality",reflect:!0})],Fs.prototype,"quality",void 0);class Hs extends xs{static get is(){return"ssao-effect"}constructor(){super(),this.strength=2,this.effects=[new jt(vs,void 0,this[ms])],this.effects[0].requireNormals=!0}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[fs](),this[As]()}update(e){super.update&&super.update(e),e.has("strength")&&this[As]()}[As](){this.effects[0].intensity=this.strength,this.effectComposer.queueRender()}[fs](){super[fs](),this.effects[0].normalBuffer=this.effectComposer.normalBuffer}get[ms](){return{worldDistanceThreshold:1e3,worldDistanceFalloff:1e3,worldProximityThreshold:1e3,worldProximityFalloff:1e3,luminanceInfluence:.7,samples:16,fade:.05,radius:.05,intensity:this.strength}}}!function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);n>3&&a&&Object.defineProperty(t,i,a)}([Se({type:Number,attribute:"strength",reflect:!0})],Hs.prototype,"strength",void 0);
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
var Ns=function(e,t,i,s){for(var r,n=arguments.length,a=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(r=e[o])&&(a=(n<3?r(a):n>3?r(t,i,a):r(t,i))||a);return n>3&&a&&Object.defineProperty(t,i,a),a};class Gs extends(bs(xs)){static get is(){return"selective-bloom-effect"}constructor(){super(),this.strength=1,this.threshold=.85,this.smoothing=.025,this.radius=.85,this.effects=[new Gt(void 0,vs,this[ms])]}connectedCallback(){super.connectedCallback&&super.connectedCallback(),this[As]()}updated(e){super.updated(e),(e.has("strength")||e.has("threshold")||e.has("smoothing")||e.has("radius"))&&this[As]()}[As](){this.effects[0].luminanceMaterial.threshold=this.threshold,this.effects[0].luminanceMaterial.smoothing=this.smoothing,this.effects[0].intensity=this.strength,this.effects[0].mipmapBlurPass.radius=this.radius,this.effectComposer.queueRender()}get[ms](){return{blendFunction:Ze.ADD,mipmapBlur:!0,radius:this.radius,luminanceThreshold:this.threshold,luminanceSmoothing:this.smoothing,intensity:this.strength}}}Ns([Se({type:Number,attribute:"strength",reflect:!0})],Gs.prototype,"strength",void 0),Ns([Se({type:Number,attribute:"threshold",reflect:!0})],Gs.prototype,"threshold",void 0),Ns([Se({type:Number,attribute:"smoothing",reflect:!0})],Gs.prototype,"smoothing",void 0),Ns([Se({type:Number,attribute:"radius",reflect:!0})],Gs.prototype,"radius",void 0),
/* @license
 * Copyright 2023 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 */
customElements.define("effect-composer",us),customElements.define("pixelate-effect",Us),customElements.define("bloom-effect",Cs),customElements.define("selective-bloom-effect",Gs),customElements.define("color-grade-effect",ys),customElements.define("outline-effect",Os),customElements.define("smaa-effect",Fs),customElements.define("ssao-effect",Hs),customElements.define("glitch-effect",Ps);export{Cs as BloomEffect,ys as ColorGradeEffect,xs as EffectBase,us as EffectComposer,Ps as GlitchEffect,Os as OutlineEffect,Us as PixelateEffect,Fs as SMAAEffect,Hs as SSAOEffect,Gs as SelectiveBloomEffect,bs as SelectiveMixin};
